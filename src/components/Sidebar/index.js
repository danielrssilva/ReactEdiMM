        ...
        <>
            <SidebarContainer>
                <SideButton
                    color="#E50304"
                    value="draw"
                    isSelected={selectedFunction === "draw" ? true : false}
                ...
                <SideButton
                    color="#E55603"
                    value="erase"
                    isSelected={selectedFunction === "erase" ? true : false}
                    setSelectedFunction={setSelectedFunction}
                >
                    <EraserIcon />
                </SideButton>
                <SideButton
                    color="#FF8B00"
                    value="move"
                    isSelected={selectedFunction === "move" ? true : false}
                    setSelectedFunction={setSelectedFunction}
                >
                    <MoveIcon />
                </SideButton>
                <SideButton
                    color="#ECCE30"
                    value="text"
                    isSelected={selectedFunction === "text" ? true : false}
                    setSelectedFunction={setSelectedFunction}
                >
                    <TextIcon />
                </SideButton>
                <SideButton
                    color="#028128"
                    value="textArea"
                    isSelected={selectedFunction === "textArea" ? true : false}
                    setSelectedFunction={setSelectedFunction}
                >
                    <TextArea />
                </SideButton>
                <SideButton
                    color="#004DFF"
                    value="shapes"
                    isSelected={selectedFunction === "shapes" ? true : false}
                    setSelectedFunction={setSelectedFunction}
                >
                    <ShapesIcon />
                </SideButton>
